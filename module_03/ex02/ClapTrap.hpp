...
/*   Updated: 2024/11/01 12:50:26 by rde-mour         ###   ########.org.br   */
/*                                                                            */
/* ************************************************************************** */
...
class ClapTrap
{
	...
	public:
		...
		bool has_hit_points(const std::string class_name) const;
		void set_energy_points(unsigned int energy_points);
		unsigned int get_energy_points(void) const;
		bool has_energy_points(const std::string class_name) const;
		void set_attack_damage(unsigned int attack_damage);
		unsigned int get_attack_damage(void) const;
		bool has_attack_damage(const std::string class_name) const;
